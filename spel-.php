                ...
                <div class="col-lg-6 col-md-8 col-sm-12">
                    ...
                    foreach ($questions as $key => $question) { ?>
                        <div class="tab-pane <?php echo $counter === 0 ? 'fade show active' : ''; ?>" role="tabpanel" aria-labelledby="question<?php echo $key + 1; ?>-tab">
                            ...
                            <label class="display-4 text-white" for="antwoord<?php echo $counter; ?>">Wat is <?php echo $question; ?>?</label><br>
                            
                            <?php 
                            $alternatives = generateCloseAlternatives($key);
                            shuffle($alternatives);
                            $correctIndex = rand(0, count($alternatives));
                            array_splice($alternatives, $correctIndex, 0, $key);
                            
                            foreach ($alternatives as $index => $alternative) { ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="antwoorden[<?php echo $counter; ?>]" id="antwoord<?php echo $counter; ?>_<?php echo $index; ?>" value="<?php echo $alternative; ?>" required>
                                    <label class="form-check-label" for="antwoord<?php echo $counter; ?>_<?php echo $index; ?>"><?php echo eval('return ' . $alternative . ';'); ?></label>
                                </div>
                            <?php } ?>
                        </div>
                    <?php
